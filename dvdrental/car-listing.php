...
<title>DVD Rental Portal | DVD Listing</title>
<!--Bootstrap -->
      ...
      <aside class="col-md-3 col-md-pull-9">
        ...
        <div class="sidebar_widget">
          <div class="widget_heading">
            <h5><i aria-hidden="true"></i> Recently Listed Movies</h5>
          </div>
...
{  ?>
              ...
              <li class="gray-bg">
                ...
                <div class="recent_post_title"> <a href="vehical-details.php?vhid=<?php echo htmlentities($result->id);?>"> <?php echo htmlentities($result->VehiclesTitle);?></a>
