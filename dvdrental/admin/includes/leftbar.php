...
<li><a href="#"><i class="fa fa-files-o"></i> Languages</a>
<ul>
<li><a href="create-brand.php">Create Language</a></li>
<li><a href="manage-brands.php">Manage Language</a></li>
</ul>
</li>

<li><a href="#"><i class="fa fa-movies"></i> Movies</a>
					<ul>
						<li><a href="post-avehicle.php">Post a Movie</a></li>
						<li><a href="manage-vehicles.php">Manage Movies</a></li>
					</ul>
				</li>
