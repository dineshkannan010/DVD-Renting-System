...
echo "Welcome To DVD rental portal";
 } ?>
          </div>
        </div>
      </div>
...
foreach($results as $result)
   ...
   <i class="fa fa-angle-down" aria-hidden="true"></i></a>
           ...
           <li><a href="post-testimonial.php">Post a Review/Recommendation</a></li>
          <li><a href="my-testimonials.php">My Review/Recommendation</a></li>
      ...
      <div class="collapse navbar-collapse" id="navigation">
        <ul class="nav navbar-nav">
          ...
          <li><a href="car-listing.php">DVD Listing</a>
