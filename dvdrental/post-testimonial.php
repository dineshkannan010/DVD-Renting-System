...
$sql="INSERT INTO  tbltestimonial(UserEmail,Movie,Testimonial,rating) VALUES(:email,:Movie,:testimonoial,:rating)";
$query = $dbh->prepare($sql);
$query->bindParam(':rating',$rating,PDO::PARAM_STR);
$query->bindParam(':testimonoial',$testimonoial,PDO::PARAM_STR);
$query->bindParam(':Movie',$Movie,PDO::PARAM_STR);
...
<title>DVD Rental Portal |Post Review/Recommendation</title>
<!--Bootstrap -->
  ...
  <div class="container">
    <div class="page-header_wrap">
      ...
      <ul class="coustom-breadcrumb">
        <li><a href="#">Home</a></li>
        <li>Post Review/Recommendation</li>
      </ul>
    </div>
  </div>
  <!-- Dark Overlay-->
    ...
    <div class="row">
      ...
      <div class="col-md-6 col-sm-8">
        <div class="profile_wrap">
          <h5 class="uppercase underline">Post a Review/Recommendation</h5>
          ...
          <form  method="post">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control white_bg" name="movie"  required=""></input>
            </div>
