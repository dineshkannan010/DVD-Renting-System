...
<head>
	...
	<title>DVD Rental Portal | Canceled Bookings   </title>
...
{				?>	
										<tr>
											...
											<td><a href="edit-vehicle.php?id=<?php echo htmlentities($result->vid);?>"><?php echo htmlentities($result->BrandName);?> , <?php echo htmlentities($result->MovieTitle);?></td>
