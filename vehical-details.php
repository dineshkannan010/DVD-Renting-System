...
echo "<script>alert('Something went wrong. Please try again');</script>";
 ...
 echo "<script>alert('DVD already booked for these days');</script>"; 
 echo "<script type='text/javascript'> document.location = 'car-listing.php'; </script>";
}
...
<title>DVD Rental | Movie Details</title>
<!--Bootstrap -->
        ...
        <div class="listing_more_info">
          <div class="listing_detail_wrap"> 
            ...
            <ul class="nav nav-tabs gray-bg" role="tablist">
              <li role="presentation" class="active"><a href="#vehicle-overview " aria-controls="vehicle-overview" role="tab" data-toggle="tab">DVD Overview </a></li>
          
              <li role="presentation"><a href="#accessories" aria-controls="accessories" role="tab" data-toggle="tab">Details</a></li>
            </ul>
        ...
        <div class="col-md-3 grid_listing">
          <div class="product-listing-m gray-bg">
            ...
            <div class="product-listing-content">
             ...
             <li><i  aria-hidden="true"></i><?php echo htmlentities($result->SeatingCapacity);?> Days</li>
